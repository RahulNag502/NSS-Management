...
<head>
    ...
    <style>
        ...
        * { transition: var(--transition); }
        ...
        .alert-warning { background-color: rgba(245, 158, 11, 0.1); color: #b45309; border-left-color: var(--warning-color); }
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto" style="font-size: 1.1rem;">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="forgot_password.php">Forgot Password</a></li>
                </ul>
            </div>
        </div>
    </nav>
